...
import sbnri.consumer.android.data.source.local.SecurePreferences;
...
public class SBNRIPref {
    ...
    @Inject
    public SBNRIPref(@ApplicationContext Context appContext) {
        preferences = new SecurePreferences(appContext);
    }

    public String getMobileNumber() {
        return getString(Constants.CONSUMER_MOBILE_NUMBER);
    }

    public int getConsumerID() {
        return getInt(Constants.CONSUMER_ID);
    }
    ...
    public String putImage(@SuppressWarnings("SameParameterValue") String theFolder, String theImageName, Bitmap theBitmap) {
    ...
    public String getBaseUrl() {
        return preferences.getString(Constants.BASE_URL, RestClient.BASE_URL);
    }

    public void putBaseUrl(String baseUrl) {
        putString(Constants.BASE_URL, baseUrl);
    }
    ...
    private String setupFullPath(String imageName) {
        ...
        if (isExternalStorageReadable() && isExternalStorageWritable() && !mFolder.exists()) {
            if (!mFolder.mkdirs()) {
               // Logger.i("ERROR", "Failed to setup folder");
                return "";
            }
        }
    ...
    private boolean saveBitmap(String fullPath, Bitmap bitmap) {
        ...
        try {
            ...
            bitmapCompressed = bitmap.compress(Bitmap.CompressFormat.JPEG, 100, out);
    ...
    public boolean getUnencryptedBoolean(String key) {
        return preferences.getUnencryptedBoolean(key);
    }
    ...
    public void putUnEncryptedBoolean(String key, boolean value) {
        checkForNullKey(key);
        preferences.edit().putUnencryptedBoolean(key, value).apply();
    }
    ...
    public void removeUnencryptedKey(String key) {
        preferences.edit().removeUnencryptedKey(key).apply();
    }
    ...
    public Map<String, ?> getUnencryptedAll() {
        return preferences.getUnencryptedAll();
    }
    ...
    public boolean isCipherKeyEncypted(String keyName){
        return preferences.isCipherKeyNameEncypted(keyName);
